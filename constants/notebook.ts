...
export const NOTEBOOK_HOLES_PADDING_HORIZONTAL = 20;
export const NOTEBOOK_HOLES_BAND_HEIGHT = 30;
export const NOTEBOOK_HOLES_SHADOW_HEIGHT = 3;
...
export const NOTEBOOK_HOLES_HEADER_HEIGHT =
  NOTEBOOK_HOLES_PADDING_TOP + NOTEBOOK_HOLES_BAND_HEIGHT + NOTEBOOK_HOLES_SHADOW_HEIGHT;

...
| `baseWordDisplay`                                                                | Surface form for lobby / keyboard / results (same role as `player_words.*.display`)                                                                  |
